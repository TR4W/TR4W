...
{ Note - # entries FOUR ARRAYS must match:
 ...
 ({Name: 'CQP';                        }Email: nil;                      DF: 'california_cty';    WA7BNM:  140; {SK3BG: nil;          } QRZRUID: 0   ; Pxm: NoPrefixMults; ZnM: NoZoneMults; AIE: NoInitialExchange; DM: DomesticFile;   P: 6 ;AE: QSONumberDomesticOrDXQTHExchange;                    XM:NoDXMults; QP:ThreePointsPerQSO; ADIFName:'';   CABName:''; CountyLineAllowed: True; FriendlyName: 'California QSO Party'),           //n4af
